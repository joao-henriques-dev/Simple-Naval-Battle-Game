...
## About
This repository contains the game logic for a turn-based naval battle and some assets needed for the GUI. It is intended to be simple, readable, and easy to play. The game's messages are shown in Portuguese. When the game finishes, a .txt file is generated with some playtime data.

## How to play
- You place 3 ships on a 6x6 grid. Each ship takes a cell in the grid.
- When all of your ships are positioned, you can start guessing where the opponent (the computer with 3 randomised coordinates) has put its ships.
